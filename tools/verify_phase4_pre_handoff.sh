...
require_contains "docs/verification/go2w_real_model_route_following.md" 'standalone opt-in smoke' "route_following_standalone_boundary"
...
require_contains "docs/handoff/new_model_initialization_prompt.md" 'Real-model same-floor route-following 有历史 PASS，但最新硬化运行显示仍可能在 DWB' "new_model_prompt_route_following_warning"
