...
require_contains "docs/architecture/architecture_state.md" 'real-model .* flat/stair/flat gate' "architecture_state_mission_real_fsf"
...
require_contains "docs/handoff/phase4_migration_handoff_report.md" 'flat/stair/flat integration gate' "handoff_phase4_mission_real_fsf"
require_contains "docs/handoff/phase4_migration_handoff_report.md" 'Mission API scheduling / assignment / control / replay / history' "handoff_phase4_mission_history_latest"
...
require_contains "docs/handoff/pre_migration_final_freeze_report.md" 'Mission runtime real-model flat/stair/flat integration gate 已完成' "final_freeze_mission_real_fsf"
require_contains "docs/handoff/pre_migration_final_freeze_report.md" 'restart_lessons_for_next_model.md' "final_freeze_restart_lessons"
require_contains "docs/handoff/restart_lessons_for_next_model.md" '最不该直接假设' "restart_lessons_assumption_warning"
require_contains "docs/handoff/restart_lessons_for_next_model.md" '规划成功当运动成功' "restart_lessons_planning_vs_motion"
require_contains "docs/handoff/restart_lessons_for_next_model.md" 'git status --short --branch' "restart_lessons_first_checks"
...
require_contains "docs/handoff/current_project_state.md" 'Mission API assignment policy' "handoff_assignment_policy"
require_contains "docs/handoff/current_project_state.md" 'Mission API workflow policy' "handoff_workflow_policy"
require_contains "docs/handoff/current_project_state.md" 'Mission API workflow backend' "handoff_workflow_backend"
require_contains "docs/handoff/current_project_state.md" 'Mission runtime real-model flat/stair/flat integration gate' "handoff_mission_real_fsf"
...
require_contains "docs/handoff/next_agent_notes.md" 'mission runtime real-model flat/stair/flat integration gate' "handoff_next_step_mission_real_fsf"
require_contains "docs/handoff/next_agent_notes.md" 'restart_lessons_for_next_model.md' "handoff_next_agent_restart_lessons"
...
require_contains "docs/verification/go2w_mission_real_flat_stair_flat.md" 'go2w_mission_real_flat_stair_flat_result: PASS' "mission_real_fsf_evidence"
require_contains "docs/verification/go2w_mission_real_flat_stair_flat.md" 'flat:10;stair:500:stair_a:F1->F2;flat:20' "mission_real_fsf_segment_summary"
...
require_contains "docs/verification/phase4e_stair_trajectory_outlet.md" 'phase4e_stair_trajectory_outlet_result: PASS' "phase4e_stair_trajectory_outlet_evidence"
...
require_contains "docs/handoff/new_model_initialization_prompt.md" 'stair trajectory outlet' "new_model_prompt_stair_trajectory_outlet"
require_contains "docs/handoff/new_model_initialization_prompt.md" 'flat/stair/flat integration gate' "new_model_prompt_mission_real_fsf"
...
require_contains "README.md" 'workflow event backend' "readme_workflow_backend"
require_contains "README.md" 'assignment policy' "readme_assignment_policy"
require_contains "README.md" '保留了目标 yaw' "readme_flat_goal_yaw"
require_contains "README.md" 'verify_go2w_mission_real_flat_stair_flat.sh' "readme_mission_real_fsf"
require_contains "README.md" 'docs/handoff/restart_lessons_for_next_model.md' "readme_restart_lessons_entry"
require_contains "docs/handoff/README.md" "当前阶段：已验收 \`Phase 4 accepted\`" "handoff_readme_current_phase4accepted"
require_contains "docs/handoff/README.md" 'docs/handoff/restart_lessons_for_next_model.md' "handoff_readme_restart_lessons_entry"
...
require_contains "docs/handoff/reading_order_and_file_map.md" 'docs/handoff/restart_lessons_for_next_model.md' "handoff_reading_order_restart_lessons"
...
bash -n \
  ...
  "${ROOT_DIR}/tools/verify_go2w_mission_real_flat_stair_flat.sh" \
  "${ROOT_DIR}/tools/verify_mission_api_scheduling_policy.sh" \
  "${ROOT_DIR}/tools/verify_mission_api_priority_scheduling.sh" \
  "${ROOT_DIR}/tools/verify_mission_api_assignment_policy.sh" \
  ...
  "${ROOT_DIR}/tools/verify_phase4e_stair_trajectory_outlet.sh" \
