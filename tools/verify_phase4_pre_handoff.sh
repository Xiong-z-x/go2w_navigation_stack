...
require_contains "docs/architecture/architecture_state.md" "Active Phase: \`Phase (3|4A|4B-min)\`" "active_phase_phase3_or_phase4"
...
require_contains "docs/handoff/current_project_state.md" '当前正式阶段：`Phase 4B-min`' "handoff_current_phase4b"
