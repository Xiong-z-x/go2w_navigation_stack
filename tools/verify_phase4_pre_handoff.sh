...
require_contains "docs/handoff/pre_migration_final_freeze_report.md" 'production Mission Orchestrator skeleton hardening' "final_freeze_next_task_production_mission"
...
require_contains "docs/handoff/next_agent_notes.md" 'production Mission Orchestrator skeleton hardening' "handoff_next_step_production_mission"
...
require_contains "README.md" 'production Mission Orchestrator skeleton hardening' "readme_next_step_production_mission"
